...
# gunicorn -k gevent -w 1 -b 0.0.0.0:7970 manage:app --reload --log-file=- --error-logfile gunicorn.error.log --access-logfile gunicorn.log --capture-output